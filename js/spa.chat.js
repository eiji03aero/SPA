...
spa.chat = (function () {
  ...
  // Begin private DOM methods handling chat messaging
  scrollChat = function () {
  ...
  // End chat messaging private DOM methods
  //---------------------- END DOM METHODS ---------------------
  ...
  onUpdatechat = function (event, msg_map) {
    ...
    // If it's neither the current user nor chatee,
    // attempts to set new chatee
  ...
  initModule = function ( $append_target ) {
    ...
    // Registering jQuery global event with [$list_box]
